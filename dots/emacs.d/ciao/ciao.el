...
(defvar ciao-bin-dir "/usr/local/bin"
  "Where the actual Ciao binaries are.")

(defvar ciao-real-lib-dir "/usr/local/lib/ciao/ciao-1.14"
  "Where the actual Ciao lib directory is (and, thus, e.g., the image files).")

(defvar ciao-info-dir "/usr/local/share/doc/ciao/"
...
(defcustom ciao-lpdoc-libpath (or (getenv "LPDOCLIB") "/usr/local/lib/lpdoc/lpdoc-3.0")
